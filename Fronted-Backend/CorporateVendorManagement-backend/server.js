...
// Login page
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, '../Fronted-Backend/Login_Signup_Pages/login.html'));

});

// Vendor register page
app.get('/register-vendor.html', (req, res) =>
    res.sendFile(path.join(__dirname, '../Fronted-Backend/Login_Signup_Pages/register-vendor.html'))
);
